          ...
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	// TODO: define a path made up of (x,y) points that the car will visit sequentially every .02 seconds
                ...
                int v_id = MY_ID;
                Trajectory trajectory = my_car.generate_trajectory(time_interval,horizon);
                Snapshot snapshot = my_car.TakeSnapshot();
                ...
                for (int i = 0; i < sensor_fusion.size(); i++)
                {
                        ...
                        Snapshot snapshot = new_car.TakeSnapshot();
                        Prediction prediction = std::make_tuple(v_id,snapshot,trajectory);
                        predictions.push_back(prediction);
                }
